...
**Typical levels in this command**: architecture and technology decisions → `5` when they are irreversible or security-sensitive, otherwise `4`; research and data-model/contract drafting → `4`; filling in template sections from decisions already made → `3`.
